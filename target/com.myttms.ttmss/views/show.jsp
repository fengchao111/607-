...
<div class="container">
    <div class="container_wrap">
        <div class="header_top">
            <div class="col-sm-3 logo"><img src="" alt=""/></div>
            ...
            <a href="/views/register.jsp" id="zhuce">注册</a>
            <a href="/views/login.jsp" id="denglu">登录</a>
            </div>
            ...
            <div class="movie_top">
                <div class="col-md-9 movie_box">
                    ...
                    <div class="movie movie-test movie-test-dark movie-test-left">
                        ...
                        <%--</div>--%>
                        <div class="movie__images">
                            <a href="/views/login.jsp" class="movie-beta__link">
                                <img alt="" src="<%=list.getPlay_image()%>" class="img-responsive" width="100%"/>
                            </a>
                        </div>
