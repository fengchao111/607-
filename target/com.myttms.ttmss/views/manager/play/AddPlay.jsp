...
<div class="mian_b">
    ...
    <form method="post" action="/play/addplay" name="joinForm" enctype="multipart/form-data">
        <div class="header_top">
            ...
            <div class="box1">
                <input type="file" id="file" class="file" name="play_image" >
                <img id="cropedBigImg" width="250" height="400" value='custom'  data-address=''>

            </div>
            <div class="footer_right">
                <label><span>名字:</span><input type="text" name="play_name" placeholder="请输入电影的名字"/></label>
                <%--<label><span>类别:</span><input type="text" name="play_type" /></label><br/>--%>
                <label><span>类别:</span>
                ...
                <label><span>上映时间:</span><input class="date_picker" name="play_up_time" type="text"  placeholder="请输入电影的上映时间"/></label>
