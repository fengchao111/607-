...
<div class="lc-block" id="l-login" data-ng-class="{'toggled':lctrl.login === 1}">
    ...
    <form action="/user/login" method="post"  id="formid" name="myform">
        ...
        <ul class="login-navigation">
            ...
            <input type="button" class="btn btn-login btn-danger" data-ng-click="lctrl.login = 0; lctrl.register = 1" value="注册">
                <input type="button" class="btn btn-login btn-danger" data-ng-click="lctrl.login = 0; lctrl.forgot = 1"  data-block="#l-forget-password" value="忘记密码">
        </ul>
    </form>
</div>
...
<div class="lc-block" id="l-register" data-ng-class="{ 'toggled': lctrl.register === 1 }" data-ng-if="lctrl.register === 1">
    ...
    <form action="/user/register" method="post">
        ...
        <ul class="login-navigation">
            ...
            <input data-block="#l-login" type="button" class="btn btn-login btn-danger" data-ng-click="lctrl.register = 0; lctrl.login = 1" value="登录"/>
                <input data-block="#l-forget-password" type="button" class="btn btn-login btn-danger" data-ng-click="lctrl.register = 0; lctrl.forgot = 1" value="忘记密码"/>
        </ul>
    </form>
</div>
    ...
    <form action="" method="post">
        ...
        <ul class="login-navigation">
            ...
            <%--<li data-block="#l-register" class="bgm-red" data-ng-click="lctrl.forgot = 0; lctrl.register = 1">Register</li>--%>
                <input data-block="#l-login" type="button" class="btn btn-login btn-danger" data-ng-click="lctrl.forgot = 0; lctrl.login = 1" value="登录"/>
