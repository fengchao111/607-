...
<body class="" data-ng-controller="loginCtrl as lctrl" style="background: url('http://img.alicdn.com/tps/i4/TB1IKI_FVXXXXcWXFXXHhe5QXXX-1400-390.jpg');text-align: center">

<%--<li style="color: red">${requestScope.errors}</li>--%>

<div class="lc-block" id="l-login" data-ng-class="{'toggled':lctrl.login === 1}">
    <h1 class="lean">607影院</h1>
    <form action="/user/register" method="post">
        ...
        <div>
            <input type="submit"  name="submit" value="注册" class="btn btn-login btn-danger btn-float"
        ...
        <ul class="login-navigation">
            ...
            <input data-block="#l-register" type="button" class="btn btn-login btn-danger" data-ng-click="lctrl.login = 0; lctrl.register = 1" value="登录"/>
            <input data-block="#l-forget-password" type="button" class="btn btn-login btn-danger" data-ng-click="lctrl.login = 0; lctrl.forgot = 1" value="忘记密码"/>
        </ul>
    </form>
</div>
...
<div class="lc-block" id="l-register" data-ng-class="{ 'toggled': lctrl.register === 1 }" data-ng-if="lctrl.register === 1">
    ...
    <form action="/user/login" method="post"  id="formid" name="myform">
        ...
        <div>
            <input type="submit"  name="submit" value="登录" class="btn btn-login btn-danger btn-float"
        ...
        <ul class="login-navigation">
            ...
            <input type="button" class="btn btn-login btn-danger" data-ng-click="lctrl.register = 0; lctrl.login = 1" value="注册">
            <input type="button" class="btn btn-login btn-danger" data-ng-click="lctrl.register = 0; lctrl.forgot = 1"  data-block="#l-forget-password" value="忘记密码">
        </ul>
    </form>
</div>
...
<div class="lc-block" id="l-forget-password" data-ng-class="{ 'toggled': lctrl.forgot === 1 }" data-ng-if="lctrl.forgot === 1">
    ...
    <form action="" method="post">
        ...
        <div>
            <input type="submit"  name="submit" value="发送" class="btn btn-login btn-danger btn-float"
        ...
        <ul class="login-navigation">
            ...
            <input data-block="#l-login" type="button" class="btn btn-login btn-danger" data-ng-click="lctrl.forgot = 0; lctrl.register = 1" value="登录"/>
            <input data-block="#l-register" type="button" class="btn btn-login btn-danger" data-ng-click="lctrl.register = 0; lctrl.forgot = 1" value="忘记密码"/>
        </ul>
    </form>
</div>
