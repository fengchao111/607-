    ...
    <div class="mian_b">
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" class="mian_b_bg_xz">
            ...
            <tr style="background-color: White; height: 30px">
                ...
                <td>
                    <input id="Text5" type="text" name="tel" style="border: 0px; width: 100px">
                </td>
                <td>
                    <input id="Text6" type="text" name="mail"style="border: 0px; width: 100px">
                </td>
                <td>
                    <input id="Text7" type="text" name="address"style="border: 0px; width: 100px">
                </td>
            </tr>
